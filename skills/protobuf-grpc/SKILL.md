---
name: protobuf-grpc
description: Protocol Buffers and gRPC(-Web) for TypeScript/browser and general use — codegen choice, the buf workflow, binary vs JSON serialization, the encrypted Envelope pattern over WebSockets, and wire-safe schema evolution. Use when working with proto files, protobuf, gRPC, buf generate, proto sync, or protocol buffers. Triggers on: "proto files", "protobuf", "gRPC", "buf generate", "proto sync", "protocol buffers".
---

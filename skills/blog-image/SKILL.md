...
user-invocable: true
argument-hint: "[image-path | title]"
---
...
and in the Claude Desktop sandbox — no headless browser, no image API.
...
- **Claude Desktop:** Pillow is already available — just run `python scripts/<script>.py ...`.

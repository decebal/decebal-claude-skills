...
//! mismatches:
//! * docs  — stale code-path references in LIVING docs (rules, guides, CLAUDE.md)
...
//! `--living CLAUDE.md,rules,docs/guides`,
...
fn main() {
    ...
    let living = roots(&args, "--living", &["CLAUDE.md", "rules", "docs/guides"]);
